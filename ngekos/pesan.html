      ...
      <header class="header black-bg">
                ...
                <ul class="nav top-menu">
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="PesanA.html#">See all messages</a>
                            </li>
                        </ul>
                    </li>
                    <!-- inbox dropdown end -->
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="SiteView.html">Logout</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  <p class="centered"><a href="berandaB.html"><img src="assets/img/seunggi.png" class="img-circle" width="60"></a></p>
                 ...
                 <li class="sub-menu">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
						  ...
						  <li><a  href="daftar_pengguna.html">Lihat Daftar Pengguna</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="searchA.html">
              ...
              <div class="row">
                  <div class="col-lg-8">
					<div class="form-panel" >
							...
							<p align="center">
								Pilih percakapan untuk menampilkan riwayat percakapan.  </br>
								 <em>Sudah diterapkan: klik Divya Maniyan </em>
							 </p>
				</div>    				
                  ...
                  <div class="col-lg-4 ds">
					...
					<div class="pre-scrollable">
                      ...
                      <div class="desc">
                      	...
                      	<div class="details">
                      		<p><a href="pesanA.html">DIVYA MANIAN</a><br/>
