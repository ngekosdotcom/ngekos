...
<html lang="en">
  <head>
    ...
    <title>Ubah Password - Penyewa</title>
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo"><b>NGekos.com</b></a>
            <!--logo end-->
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="ubah_passwordB.html">Ubah Password</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="pindah_kamar.html">Pindah Kamar</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="searchB.html">
