          ...
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb">Daftar Tunggu</h4>
                      <form class="form-horizontal style-form" method="get">
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Pemesan 4</label>
                              <div class="col-sm-10">
                                  <a class="btn btn-success">Terima</a><a class="btn btn-danger">Tolak</a>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Pemesan 3</label>
                              <div class="col-sm-10">
                                  <a class="btn btn-success">Terima</a><a class="btn btn-danger">Tolak</a>
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Pemesan 2</label>
                              <div class="col-sm-10">
                                  <a class="btn btn-success">Terima</a><a class="btn btn-danger">Tolak</a>
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Pemesan 1</label>
                              <div class="col-sm-10">
                                  <a class="btn btn-success">Terima</a><a class="btn btn-danger">Tolak</a>
                              </div>
                          </div>
