          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="lihat_profilB.html">Lihat Profil</a></li>
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form">
                          <div class="form-group">
                              <div class="col-sm-10">
                                  <img src="assets/img/yoona.png" class="img-thumbnail">
                              </div>
                          </div>
						  <div class="form-group">
								  <label class="col-sm-2 col-sm-2 control-label">Nama</label>
								  <div class="col-sm-10">
									  <p class="form-control-static">Fatih Wahyu Kusuma</p>
								  </div>
							  </div>
							  <div class="form-group">
