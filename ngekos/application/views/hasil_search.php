      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb">Kos 1</h4>
                      <form class="form-horizontal style-form" method="get">
                          <div class="form-group">
                              <div class="col-sm-10">
                                  <img src="assets/img/kos1.jpg" class="img-thumbnail">
								  <div><button type="submit" class="btn btn-theme">Pilih</button></div>
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama Kos</label>
                              <div class="col-sm-10">
                                  <p class="form-control-static">Graha Bouraq</p>
                              </div>
                          </div>
                          <div class="form-group">
						  ...
						  <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <p class="form-control-static">30 x 10 meter</p>
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Jumlah Lantai</label>
                              <div class="col-sm-10">
				  ...
				  <div class="form-panel">
                  	  <h4 class="mb">Kos 2</h4>
                      <form class="form-horizontal style-form" method="get">
                          <div class="form-group">
                              <div class="col-sm-10">
                                  <img src="assets/img/kos2.jpg" class="img-thumbnail">
								  <div><button type="submit" class="btn btn-theme">Pilih</button></div>
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama Kos</label>
                              <div class="col-sm-10">
                                  <p class="form-control-static">Kos Adila</p>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Jumlah Kamar</label>
                              <div class="col-sm-10">
                                  <p class="form-control-static">13</p>
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Luas Tanah</label>
                              <div class="col-sm-10">
                                  <p class="form-control-static">40 x 20 meter</p>
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Jumlah Lantai</label>
				  ...
				  <div class="form-panel">
                  	  <h4 class="mb">Kos 3</h4>
                      <form class="form-horizontal style-form" method="get">
                          <div class="form-group">
                              <div class="col-sm-10">
                                  <img src="assets/img/kos3.jpg" class="img-thumbnail">
								  <div><button type="submit" class="btn btn-theme">Pilih</button></div>
                              </div>
                          </div>
						  <div class="form-group">
