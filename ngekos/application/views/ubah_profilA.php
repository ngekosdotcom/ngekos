...
<html lang="en">
  <head>
    ...
    <title>Lihat Profil - Pemilik</title>
          ...
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb">Ubah Profil</h4>
                      <form class="form-horizontal style-form" method="post" action="" multiple>
                          <div class="form-group">
                              <div class="col-sm-10">
                                  <textarea readonly rows='10'>Unggah Foto Profil</textarea>
								  <input type="file" name="pp" id = "pp" multiple>
                              </div>
                          </div>
						  <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="date" name="tanggal" class="form-control" value="<?php echo $this->session->userdata('tgl_lahir');?>">
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Alamat</label>
                              <div class="col-sm-10">
                                  <input type="text" name = "alamat" class="form-control" "<?php echo $this->session->userdata('alamat');?>">
                              </div>
                          </div>
						  <input type="submit" class="btn btn-theme" name="simpan">Simpan</button>
                      </form>
                  </div>
