      ...
      <header class="header black-bg">
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="pengumumanB.html">Switch to Penyewa</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="pengumumanA.html">Pengumuman</a></li>
      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb">Ubah Pengumuman</h4>
                      <form class="form-horizontal style-form" method="get">
                          <div class="form-group">
                              <div class="col-sm-10">
                                  <textarea rows='10' class="form-control">Kamar A, C, dan F belum bayar untuk bulan ini, harap segera bayar.</textarea>
								  <br>
								  <a class="btn btn-theme" href="pengumumanA.html">Simpan</a>
                              </div>
                          </div>
					  </form>
					</div>
