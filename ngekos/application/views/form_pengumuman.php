      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb">Buat Pengumuman</h4>
                      <form class="form-horizontal style-form" method="post" action="<?php echo base_url(); ?>index.php/Koscontroller/buat_pengumuman/<?php echo $kos."/"; if(isset($pengumuman)){ echo $pengumuman;} else echo -1; ?>">
                          <div class="form-group">
                              <div class="col-sm-10">
                                  <textarea rows='10' name="isi" value="" class="form-control"><?php if(isset($isi)){ echo $isi;} ?></textarea>
								  <br>
								  <input type="submit" value="Simpan" class="btn btn-theme">
                              </div>
                          </div>
					  </form>
					</div>
