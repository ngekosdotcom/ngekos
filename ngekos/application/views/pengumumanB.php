      ...
      <header class="header black-bg">
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="pengumumanA.html">Switch to Pemilik</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="pengumumanB.html">Pengumuman</a></li>
      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  &nbsp &nbsp <a href="form_pengumuman.html"><button type="submit" class="btn btn-theme">Buat Pengumuman</button></a>
                  <div class="form-panel">
