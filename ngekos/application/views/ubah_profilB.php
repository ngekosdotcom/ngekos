...
<html lang="en">
  <head>
    ...
    <title>Lihat Profil - Penyewa</title>
      ...
      <header class="header black-bg">
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="masuk.html">Logout</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
						  ...
						  <li class="active"><a  href="ubah_profilB.html">Ubah Profil</a></li>
                      ...
                      <form class="form-horizontal style-form" method="get">
                          <div class="form-group">
                              <div class="col-sm-10">
								  ...
								  <input type="file" name="pp" multiple>
                              </div>
                          </div>
						  <div class="form-group">
