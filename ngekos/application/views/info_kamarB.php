      ...
      <header class="header black-bg">
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="berandaA.html">Switch to Pemilik</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a class="active" href="searchB.html">
          ...
          <section class="wrapper">
              ...
              <div class="row">
                  <div class="col-lg-9">
					  ...
					  <h4 class="mb">Kamar F</h4>
                      <form class="form-horizontal style-form" method="get">
                          <div class="form-group">
                              <div class="col-sm-10">
                                  <img src="assets/img/kamar.jpg" class="img-thumbnail">
								  <div><a class="btn btn-theme" onclick="confirm()">Pesan Kamar</a>
								  <a class="btn btn-theme" href="waiting_listA.html">Lihat Daftar Tunggu</a></div>
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nomor Kamar</label>
                              <div class="col-sm-10">
                                  <p class="form-control-static">7</p>
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama Penghuni</label>
                              <div class="col-sm-10">
                                  <p class="form-control-static">Seo Joo-Hyun</p>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Ukuran Kamar</label>
                              <div class="col-sm-10">
                                  <p class="form-control-static">7 x 8 meter</p>
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Harga Sewa per Bulan</label>
                              <div class="col-sm-10">
                                  <p class="form-control-static">Rp 750.000</p>
                              </div>
                          </div>
                      </form>
				  </div>
