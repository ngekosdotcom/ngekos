      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
		...
		if($data->num_rows() == 0)
		{
			...
			{?>
				<div class="form-panel">
							<h4 class="mb"><i class="fa fa-angle-right"></i> Kos <?php echo $nrows;?></h4>
							<form class="form-horizontal style-form" method="get">
								<div class="form-group">
									<div class="col-sm-10">
										<a href="<?php echo base_url();?>index.php/Koscontroller/lihat_kos/<?php echo $row->id;?>"><img src="<?php echo $row->url;?>" class="img-thumbnail" width="100" height="100"></a>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">Nama Kos</label>
									<div class="col-sm-10">
										<a href="<?php echo base_url();?>index.php/Koscontroller/lihat_kos/<?php echo $row->id;?>"><p class="form-control-static"><?php echo $row->nama.'</p></a>';?>
									</div>
									<label class="col-sm-2 col-sm-2 control-label">Alamat</label>
									<div class="col-sm-10">
										<p class="form-control-static">Jl.<?php echo $row->jalan.' No.'.$row->no.' RT '.$row->rt.' RW '.$row->rw.' '.$row->kelurahan.', '.$row->kecamatan.', '.$row->kota.', '.$row->provinsi.', '.$row->kodepos.'</p>';?>
									</div>
									<div class="col-sm-10">
										<a class="btn btn-theme" href="<?php echo base_url();?>index.php/Koscontroller/form_ubah_kos/<?php echo $row->id."/".$row->id;?>">Ubah</a>
										<a class="btn btn-theme" href="<?php echo base_url();?>index.php/Koscontroller/lihat_daftar_kos/<?php echo $row->id;?>">Pilih</a>
									</div>
								</div>
							</div>
						</form>
