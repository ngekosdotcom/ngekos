      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
				  ...
				  <h3 align="center" class="mb">Pengumuman</h3>
				   <?php if(strcmp($kos,'belum_ada') == 0){ ?>
					<div class="form-panel">Anda belum membuat kos.</div>
				   <?php }else{?>
					&nbsp &nbsp <a href="<?php echo base_url(); ?>index.php/Koscontroller/show_buat_pengumuman/<?php echo $kos; ?>"><button class="btn btn-theme">Buat Pengumuman</button></a>
					  <?php if($data->num_rows() == 0) {?>
						<div class="form-panel">Tidak ada pengumuman untuk kos ini.</div>
					  <?php }else{?>
						<?php foreach($data->result_array() as $row){ ?>
						<div class="form-panel">
							<?php $tanggal= explode(' ',$row['timestamp']); ?>
						  <h5><?php echo $tanggal[0];?></h5>
						  <h5><?php echo $tanggal[1];?></h5>
						  <form class="form-horizontal style-form" method="get">
							  <div class="form-group">
								  <div class="col-sm-10">
									  <textarea readonly rows='10' class="form-control"><?php echo $row['isi'];?></textarea>
									  <a class="btn btn-theme" href="<?php echo base_url();?>index.php/Koscontroller/ubah_pengumuman/<?php echo $kos."/".$row['id']; ?>">Ubah</a><a class="btn btn-theme" href="<?php echo base_url();?>index.php/Koscontroller/hapus_pengumuman/<?php echo $kos."/".$row['id']; ?>">Hapus</a>
								  </div>
							  </div>
						  </form>
						</div>
				  ...
				  <?php }?>
                  <!--div class="form-panel">
                  	  <h5>Rabu, 11 Maret 2015</h5>
					  <h5>19:34</h5>
                      <form class="form-horizontal style-form" method="get">
                          <div class="form-group">
                              <div class="col-sm-10">
                                  <textarea readonly rows='10' class="form-control">Kamar A, C, dan F belum bayar untuk bulan ini, harap segera bayar.</textarea>
								  <a class="btn btn-theme" href="ubah_pengumuman.html">Ubah</a><a class="btn btn-theme" href="ubah_pengumuman.html">Hapus</a>
                              </div>
                          </div>
					  </form>
					</div>
				  <div class="form-panel">
                  	  <h5>Minggu, 1 Maret 2015</h5>
					  <h5>19:34</h5>
                      <form class="form-horizontal style-form" method="get">
                          <div class="form-group">
                              <div class="col-sm-10">
                                  <textarea readonly rows='10' class="form-control">Mulai bulan ini harga sewa kamar naik Rp 50.000, tapi dapat wifi</textarea>
								  <a class="btn btn-theme" href="ubah_pengumuman.html">Ubah</a><a class="btn btn-theme" href="ubah_pengumuman.html">Hapus</a>
                              </div>
                          </div>
					  </form>
