...
<html lang="en">
  <head>
    ...
    <title>Ubah Password - Pemilik</title>
          ...
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="post" action="<?php echo base_url()?>Akuncontroller/ubahpass/<?php echo $kos; ?>" >
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" for="passlama">Password Lama</label>
                              <div class="col-sm-10">
                                  <input type="password"  class="form-control" placeholder="" name="passlama">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" for="passbaru">Password Baru</label>
                              <div class="col-sm-10">
                                  <input type="password"  class="form-control" placeholder="" name="passbaru">
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" for="conpassbaru">Ulangi Password Baru</label>
                              <div class="col-sm-10">
                                  <input type="password"  class="form-control" placeholder="" name = "conpassbaru">
                              </div>
                          </div>
						  <input type="submit" class="btn btn-theme" name ="simpan" value="simpan">
                      </form>
                  </div>
