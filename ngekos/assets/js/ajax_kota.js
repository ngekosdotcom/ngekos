...
function ajaxkota(id){
    ajaxku = buatajax();
    var url="http://localhost/ngekos/index.php/Lokasicontroller/get_kabupaten/"+id;
...
function ajaxkec(id){
    ajaxku = buatajax();
    var url="http://localhost/ngekos/index.php/Lokasicontroller/get_kecamatan/"+id;
...
function ajaxkel(id){
    ajaxku = buatajax();
    var url="http://localhost/ngekos/index.php/Lokasicontroller/get_kelurahan/"+id;
